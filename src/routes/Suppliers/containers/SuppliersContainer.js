...
const mapDispatchToProps = (dispatch) => ({
  ...
  updateSupplier: formApiAdapter(dispatch, updateSupplier),
  deleteSupplier: formApiAdapter(dispatch, deleteSupplier),
  addSupplier: formApiAdapter(dispatch, addSupplier)
})
